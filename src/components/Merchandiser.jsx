...
const Merchandiser = () => {
  ...
  const initialBuyers = [
    {
      id: 1,
      MerchandiserName:'ARNAB HASAN'
    },
    {
      id: 2,
      MerchandiserName:'United States'
    }
  ];
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Merchandiser Management</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div className="premium-card p-4 rounded-lg border border-gray-200 shadow-sm">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">Total Merchandiser</p>
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="">
              <tr>
                {[
                  { key: 'MerchandiserName', label: 'Merchandiser_Name' },
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center gap-2">
                        <div className="h-8 w-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white text-sm font-medium">
                          {buyer.MerchandiserName.split(' ').map(n => n[0]).join('')}
                        </div>
                        <div className="text-sm text-slate-800">{buyer.MerchandiserName}</div>
                      </div>
                    </td>
          ...
          <div className="premium-card rounded-lg shadow-xl w-full max-w-md">
            <div className="px-6 py-4 border-b border-gray-200">
              <h2 className="text-lg font-semibold text-slate-800">
                {editingBuyer ? 'Edit Merchandiser' : 'Add Merchandiser'}
              </h2>
            </div>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">           
              ...
              <div className="flex justify-end space-x-3 pt-4">
                ...
                >
                  {editingBuyer ? 'Update' : 'Add'} Merchandiser
                </button>
              </div>
            </form>
          </div>
