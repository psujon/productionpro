...
const AccessoriesType = () => {
  ...
  const initialBuyers = [
    {
      id: 1,
      StyleName:'asdfaf',
      AccessoriesType: 'asdfasdfa',
      AccessoriesUnit: 'asdfasdfas',
      AccessoriesOrderDate: new Date().toISOString().split('T')[0],
      AccessoriesReceivedDate: new Date().toISOString().split('T')[0],
      AccessoriesQuantity: 5000
    },
    {
      id: 2,
      StyleName:'asdfasdf',
      AccessoriesType: 'asdfasdf',
      AccessoriesUnit: 'asdfasdf',
      AccessoriesOrderDate: new Date().toISOString().split('T')[0],
      AccessoriesReceivedDate: new Date().toISOString().split('T')[0],
      AccessoriesQuantity: 2000
    }
  ];
  ...
  const handleEdit = (buyer) => {
    ...
    setFormData({
      ...
      AccessoriesType: buyer.AccessoriesType,
      AccessoriesUnit: buyer.AccessoriesUnit,
      AccessoriesOrderDate: buyer.AccessoriesOrderDate,
      AccessoriesReceivedDate: buyer.AccessoriesReceivedDate,
      AccessoriesQuantity:buyer.AccessoriesQuantity
    });
    setIsModalOpen(true);
  };
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Accessories Type</h1>
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="">
              <tr>
                {[
                  { key: 'StyleName', label: 'Style_Name' },
                  { key: 'AccessoriesType', label: 'Accessories_Type' },
                  { key: 'AccessoriesUnit', label: 'Unit' },
                  { key: 'AccessoriesOrderDate', label: 'Accessories_Order_Date' },
                  { key: 'Accessories_Received_Date', label: 'AccessoriesReceivedDate' },
                  {key:'AccessoriesQuantity', label:'Accessories_Quantity'},
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <div className="h-8 w-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white text-sm font-medium">
                          {buyer.StyleName.split(' ').map(n => n[0]).join('')}
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-slate-800">{buyer.AccessoriesType}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-slate-800">{buyer.AccessoriesUnit}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-800">
                      {new Date(buyer.AccessoriesOrderDate).toLocaleDateString()}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-800">
                      {new Date(buyer.AccessoriesReceivedDate).toLocaleDateString()}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-800">
                      {buyer.AccessoriesQuantity}
                    </td>
          ...
          <div className="premium-card rounded-lg shadow-xl w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div className="flex justify-end space-x-3 pt-4">
                ...
                >
                  {editingBuyer ? 'Update' : 'Add'} Accessories
                </button>
              </div>
            </form>
          </div>
