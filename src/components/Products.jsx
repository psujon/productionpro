        ...
        <div className="premium-card p-4 rounded-lg border border-gray-200 shadow-sm">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-slate-800">
                {buyers.reduce((sum, buyer) => sum + buyer.MRP, 0)}
              </p>
            </div>
          </div>
        </div>
                    ...
                    <td className="px-6 py-4 break-words">
                      <div className="flex items-center">
                        <div className="h-8 w-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white text-sm font-medium shrink-0">
                          {buyer.ProductCode.split(' ').map(n => n[0]).join('')}
                        </div>
                        <div className="ml-4">
                          <div className="text-sm font-medium text-slate-800">{buyer.ProductCode}</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 break-words">
                      <div className="text-sm text-slate-800">{buyer.ProductName}</div>
                    </td>
                    <td className="px-6 py-4 break-words">
                      <div className="text-sm text-grey-900">{buyer.Unit}</div>
                    </td>
                    <td className="px-6 py-4 break-words">
                      <div className="text-sm text-slate-800">{buyer.MRP}</div>
                    </td>
                    <td className="px-6 py-4 break-words">
                      <div className="text-sm text-slate-800">{buyer.Stock}</div>
                    </td>
                    <td className="px-6 py-4 break-words">
          ...
          <div className="premium-card rounded-lg shadow-xl w-full max-w-md">
            <div className="px-6 py-4 border-b border-gray-200">
              <h2 className="text-lg font-semibold text-slate-800">
                {editingBuyer ? 'Edit Products' : 'Add New Products'}
              </h2>
            </div>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div className="flex justify-end space-x-3 pt-4">
                ...
                >
                  {editingBuyer ? 'Update' : 'Create'} Products
                </button>
              </div>
            </form>
          </div>
